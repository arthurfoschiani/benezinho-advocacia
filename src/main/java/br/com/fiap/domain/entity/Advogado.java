...
@Table(name = "TB_ADVOGADO", uniqueConstraints = {
        @UniqueConstraint(name = "UK_NMR_OAB_ADVOGADO", columnNames = {"NMR_OAB"})
})
public class Advogado {
    ...
    private String nome;
    @Column(name = "NMR_OAB", nullable = false)
    private String numeroOAB;
    @ManyToOne(fetch = FetchType.EAGER, cascade = {CascadeType.PERSIST, CascadeType.MERGE})
    @JoinColumn(name = "ID_ESTADO", referencedColumnName = "ID_ESTADO", foreignKey = @ForeignKey(name = "FK_ESTADO"))
    ...
    public String toString() {
        return id + " - " + nome + " - " + numeroOAB + " - " + estado;
    }
}
